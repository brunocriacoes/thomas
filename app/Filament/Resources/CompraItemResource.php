...
use App\Filament\Resources\CompraItemResource\Pages;
use App\Filament\Resources\CompraItemResource\RelationManagers;
...
class CompraItemResource extends Resource
{
    protected static ?string $model = CompraItem::class;
    ...
    {
        return [
            'index' => Pages\ManageCompraItems::route('/'),
        ];
    }
}
